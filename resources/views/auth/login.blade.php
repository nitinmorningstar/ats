        ...
        <div class="login-box login-sidebar">
            <div class="white-box">
                <form class="form-horizontal form-material" method="POST" id="loginform" action="{{ route('login') }}">
                    @csrf
                    <a href="javascript:void(0)" class="text-center db"><img src="{{ asset('theme/plugins/images/eliteadmin-logo-dark.png')}}" alt="Home" />
                        <br/><img src="{{ asset('theme/plugins/images/eliteadmin-text-dark.png')}}" alt="Home" /></a>
